                ...
                function askReportFile() {
                    ...
                    rl.question(clc.bold(questionInputReportFile), inputReportFile => {
                        ...
                        if(inputReportFile.includes(' ')) {
                            ...
                            console.log(clc.red('Path folder report tidak boleh ada tanda aneh!, tolong masukkan nama nya sesuai format yang di berikan'));
                            return askReportFile();
                        }
                                                        ...
                                                        if(inputPassword.trim() === '') {
                                                            ...
                                                            if(response.ok) {
                                                                if(response?.body?.status === false) {
                                                                    ...
                                                                    const { email, role: { id: kind } } = response?.body?.data?.user;
                                                                    data.accounts.push(`akun=${email};${inputPassword};${kind}`);
